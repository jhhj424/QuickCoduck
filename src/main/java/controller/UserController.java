...
public class UserController {
	...
	public ModelAndView list(Integer pageNum, String searchType, String searchContent, Integer type,
		...
		// 총 게시물 건수
		int listcount = service.boardcount(searchType, searchContent, type, id, dtype, matching);
		// boardlist : 한페이지에 출력할 게시물 정보 저장
		List<Board> boardlist = service.boardlist(searchType, searchContent, pageNum, limit, type, id, dtype, matching);
