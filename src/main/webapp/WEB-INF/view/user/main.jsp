...
<h1><a href="../user/myduck.duck?id=${user.userid}&ducktype=1&boardtype=1">덕한거보기</a></h1>
<h1><a href="../user/myduck.duck?id=${user.userid}&ducktype=1&boardtype=3">스크랩보기</a></h1>
